gen_enforced_field(WorkspaceCwd, 'homepage', 'https://github.com/neetly/editor').
gen_enforced_field(WorkspaceCwd, 'repository.type', 'git').
gen_enforced_field(WorkspaceCwd, 'repository.url', 'git@github.com:neetly/editor.git').
